        ...
        <div class="main-body">
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="{{url('upload/vendor_image')}}/{{!empty($vendorData->photo)?$vendorData->photo:'no_image.jpg'}}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                <div class="mt-3">
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('vendor.profile.store')}}" enctype="multipart/form-data" method="post">
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" disabled class="form-control" value="{{$vendorData->username}}" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        <textarea class="form-control" name="address">{{$vendorData->address}}</textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="date" class="form-control" name="join" value="{{$vendorData->vendor_join}}" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        <textarea class="form-control" name="info">{{$vendorData->vendor_short_info}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img src="{{url('upload/vendor_image')}}/{{!empty($vendorData->photo)?$vendorData->photo:'no_image.jpg'}}" alt="Admin" class="rounded p-1 bg-primary" id="showImage" width="110">
                                    </div>
                                </div>
