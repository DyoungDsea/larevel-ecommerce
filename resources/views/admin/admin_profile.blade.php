                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="{{url('upload/admin_image')}}/{{!empty($adminData->photo)?$adminData->photo:'no_image.jpg'}}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                <div class="mt-3">
                            ...
                            <form action="{{route('admin.profile.store')}}" enctype="multipart/form-data" method="post">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" disabled class="form-control" value="{{$adminData->username}}" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                    <img src="{{url('upload/admin_image')}}/{{!empty($adminData->photo)?$adminData->photo:'no_image.jpg'}}" alt="Admin" class="rounded p-1 bg-primary" id="showImage" width="110">
                                    </div>
                                </div>
